...
export const WEAPON_BOOK: Record<string, ItemSpec> = {
    ...
    NORMAL_SWORD: { id: "NORMAL_SWORD", name: "노말 검", atk: 3, price: 15 },
    SWORD: { id: "SWORD", name: "검", atk: 5, price: 25 },
    RARE_SWORD: { id: "RARE_SWORD", name: "레어 검", atk: 10, price: 45 },
    EPIC_SWORD: { id: "EPIC_SWORD", name: "에픽 검", atk: 15, price: 80 },
    UNIQUE_SWORD: { id: "UNIQUE_SWORD", name: "유니크 검", atk: 25, price: 140 },
    LEGENDARY_SWORD: { id: "LEGENDARY_SWORD", name: "레전더리 검", atk: 40, price: 220 },
};
